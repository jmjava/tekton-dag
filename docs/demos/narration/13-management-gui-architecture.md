...
2. Every Tekton or Kubernetes action goes to Flask under slash api, which uses the configured kubeconfig or in-cluster config.
3. The team switcher sets the active team; API paths look like slash api slash teams slash the team slash pipelineruns.
