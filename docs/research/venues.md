...
| **Later, when a site exists** | [ICSE SEIP](https://conf.researchr.org/track/icse-2027/icse-2027-seip) (or the next year’s practice track) | Right venue for a named industrial problem + evidence. **Not** a 2026 crash effort. | Reviewers expect context, method, and evidence — Kind + sample apps will not pass. See [seip-tasks.md](seip-tasks.md). | whenever you next have a CFP and Gate 0 is go |
