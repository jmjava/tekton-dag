...
- Demo page [`index.html`](index.html) embeds **all 19 segments** plus **full-demo** / **full-demo-complete**; deep-link with fragments e.g. `…/tekton-dag/#seg-07` (see root [README](../README.md) demo table).
...
3. **Quick check** — Open the MP4 directly:  
   `https://jmjava.github.io/tekton-dag/demos/recordings/15-regression-suite.mp4`  
   Compare file size or first frame to your local `docs/demos/recordings/15-regression-suite.mp4`.
