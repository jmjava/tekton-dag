...
| [M10.1](milestones/milestone-10-1.md) | **Completed** | Orchestration service testing: build image, deploy to Kind, Postman test suite (15 requests, 30 assertions), integration validation. |
...
→ **Milestone 10** — Multi-team scaling and in-cluster orchestration. See [milestones/milestone-10.md](milestones/milestone-10.md). Then M9 (test-trace graph), then M8 (demo assets).
